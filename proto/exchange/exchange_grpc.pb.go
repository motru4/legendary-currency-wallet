...
type ExchangeServiceClient interface {
	GetExchangeRates(ctx context.Context, in *ExchangeRatesRequest, opts ...grpc.CallOption) (*ExchangeRatesResponse, error)
	GetExchangeRateForCurrency(ctx context.Context, in *CurrencyPairRequest, opts ...grpc.CallOption) (*ExchangeRateResponse, error)
}
...
func (c *exchangeServiceClient) GetExchangeRates(ctx context.Context, in *ExchangeRatesRequest, opts ...grpc.CallOption) (*ExchangeRatesResponse, error) {
...
func (c *exchangeServiceClient) GetExchangeRateForCurrency(ctx context.Context, in *CurrencyPairRequest, opts ...grpc.CallOption) (*ExchangeRateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ExchangeServiceServer interface {
	GetExchangeRates(context.Context, *ExchangeRatesRequest) (*ExchangeRatesResponse, error)
	GetExchangeRateForCurrency(context.Context, *CurrencyPairRequest) (*ExchangeRateResponse, error)
...
func (UnimplementedExchangeServiceServer) GetExchangeRates(context.Context, *ExchangeRatesRequest) (*ExchangeRatesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetExchangeRates not implemented")
}
func (UnimplementedExchangeServiceServer) GetExchangeRateForCurrency(context.Context, *CurrencyPairRequest) (*ExchangeRateResponse, error) {
...
func _ExchangeService_GetExchangeRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).GetExchangeRates(ctx, req.(*ExchangeRatesRequest))
	}
...
func _ExchangeService_GetExchangeRateForCurrency_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).GetExchangeRateForCurrency(ctx, req.(*CurrencyPairRequest))
	}
	return interceptor(ctx, in, info, handler)
}
